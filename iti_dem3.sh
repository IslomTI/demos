#!/bin/bash
# ==============================================================================
# Master Script - V4 (FRR Fix + Docker Pre-pull + Moodle Auto-download)
# ==============================================================================
...
clear
echo -e "${YELLOW}=================================================${NC}"
echo -e "${GREEN} ЭКЗАМЕН - ФИНАЛЬНАЯ ВЕРСИЯ (С ПРЕДЗАГРУЗКОЙ)${NC}"
echo -e "${YELLOW}=================================================${NC}"
